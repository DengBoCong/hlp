...
def dispatch_pre_treat_func(func_type: str, data_path: str, dataset_infos_file: str, max_time_step: int,
                            ...
                            transcript_row: int = 0, max_treat_data_size: int = 0):
    """
    预处理方法分发匹配
    ...
    """
    operation = {
        "thchs30": lambda: preprocess_thchs30_speech_raw_data(data_path=data_path, max_time_step=max_time_step,
                                                              ...
                                                              max_treat_data_size=max_treat_data_size,
                                                              vocab_size=vocab_size, dict_path=dict_path),
        "librispeech": lambda: preprocess_librispeech_speech_raw_data(data_path=data_path, max_time_step=max_time_step,
                                                                      dataset_infos_file=dataset_infos_file,
                                                                      spectrum_data_dir=spectrum_data_dir,
                                                                      audio_feature_type=audio_feature_type,
                                                                      save_length_path=save_length_path,
...
def preprocess_thchs30_speech_raw_data(data_path: str, dataset_infos_file: str, max_time_step: int,
                                       ...
                                       transcript_row: int = 0, start_sign: str = "<start>", dict_path: str = "",
                                       end_sign: str = "<end>", unk_token: str = "<unk>", max_treat_data_size: int = 0):
    """
    ...
    print(train_sentence_sequences)
    exit(0)
...
def preprocess_librispeech_speech_raw_data(data_path: str, dataset_infos_file: str, max_time_step: int,
                                           ...
                                           audio_feature_type: str = "mfcc", max_treat_data_size: int = 0):
    """
