...
def setup_train_args():
    ...
    parser.add_argument('--vocab_path', default='vocab/vocab_1.txt', type=str, required=False, help='选择词库')
    parser.add_argument('--train_raw_path', default='data/data_small.txt', type=str, required=False, help='原始训练语料')
