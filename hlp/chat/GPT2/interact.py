...
def set_interact_args():
    ...
    parser.add_argument('--dialogue_model_path', default='dialogue_model/model_epoch5/', typsonge=str, required=False, help='对话模型路径')
...
def main():
    ...
    while True:
        try:
            ...
            curr_input_tensor = torch.tensor(input_ids).long().to(device)#完整的输入id
            generated = []
            # 最多生成max_len个token
