...
checkpoint_path_en_zh = conf["checkpoint_path_en_zh"]   # 检查点路径
checkpoint_path_zh_en = conf["checkpoint_path_zh_en"]   # 检查点路径
...
zh_tokenizer_path = conf["zh_tokenizer_path"]  # 中文tokenize字典保存路径
